...
export const WIDGETS: WidgetInfo[] = [
  ...
  // ---- interactive pro ----
  {
    ...
    maps_to: "off-canvas",
    category: "interactive",
    description: "Off-canvas panel (Pro). Slide-out panel for menus, filters, or content. `props` for content, position, animation.",
    fields: ["props"],
  },
  {
    type: "media-carousel",
    maps_to: "media-carousel",
    category: "media",
    description: "Media carousel (Pro). Multi-slide carousel for images/videos with navigation. `props.slides`: [{image:{url}, caption?}].",
    fields: ["props"],
    aliases: ["carousel-pro"],
  },
  {
    type: "hotspot",
    maps_to: "hotspot",
    category: "interactive",
    description: "Hotspot (Pro). Interactive markers on an image with tooltips. `props.hotspots`: [{x, y, title, description}].",
    fields: ["props"],
  },
  {
    type: "code-highlight",
    maps_to: "code-highlight",
    category: "content",
    description: "Code highlight (Pro). Syntax-highlighted code block with copy button. `props.code`, `props.language`.",
    fields: ["props"],
  },
  {
    type: "video-playlist",
    maps_to: "video-playlist",
    category: "media",
    description: "Video playlist (Pro). YouTube/Vimeo playlist widget. `props.videos`: [{url, title?}].",
    fields: ["props"],
  },
  {
    type: "text-path",
    maps_to: "text-path",
    category: "content",
    description: "Text path (Free). Creative text displayed along a curved or straight path. `props.text`, `props.path`.",
    fields: ["props"],
  },
  {
    type: "link-in-bio",
    maps_to: "link-in-bio",
    category: "content",
    description: "Link in bio (Free). Linktree-style landing page for social profiles. `props.links`: [{text, url, icon?}], `props.avatar`.",
    fields: ["props"],
  },
  {
    type: "share-buttons",
    maps_to: "share-buttons",
    category: "interactive",
    description: "Share buttons (Pro). Social sharing buttons for current page. `props.networks` is an array of network names (facebook, twitter, linkedin, etc.).",
    fields: ["props"],
  },
  // ---- escape hatch ----
  {
